        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 8) {
                ...
                if recipe.servings > 1 {
                    RecipeOverlayMetricBadge(icon: "person.2", text: "\(recipe.servings)")
                }
...
private struct RecipeOverlayMetricBadge: View {
    let icon: String
    let text: String
    ...
    private var bottomContent: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(spacing: 8) {
                ...
                if recipe.servings > 1 {
                    RecipeOverlayMetricBadge(icon: "person.2", text: "\(recipe.servings)", size: .compact)
                }
            }
        }
        .padding(.horizontal, 14)
